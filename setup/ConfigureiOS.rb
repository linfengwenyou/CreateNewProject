module Pod
  ...
  class ConfigureIOS
    ...
    keep_demo = "no" #configurator.ask_with_answers("Would you like to include a demo application with your library", ["Yes", "No"]).to_sym

    framework = "no" #configurator.ask_with_answers("Which testing frameworks will you use", ["Specta", "Kiwi", "None"]).to_sym
      case framework
        when :specta
    ...
    snapshots = "no" # configurator.ask_with_answers("Would you like to do view based testing", ["Yes", "No"]).to_sym
      ...
      loop do
          prefix = "LWS" # configurator.ask("What is your class prefix")
